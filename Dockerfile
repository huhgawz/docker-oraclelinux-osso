...
COPY osso.conf /private/softwares/Oracle/Middleware/Oracle_WT1/instances/instance1/config/OHS/ohs1
COPY mod-osso.conf /private/softwares/Oracle/Middleware/Oracle_WT1/instances/instance1/config/OHS/ohs1/moduleconf/
